...
assert_contains "README.md" 'unitt!'
...
assert_contains "README.md" 'Wardrobe Inventory'
assert_contains "README.md" '左側'
assert_contains "README.md" 'right-side inventory'
assert_contains "README.md" 'Wear'
assert_contains "Packages/com.unitt.avatar-mod/README.md" 'unitt!'
...
assert_contains "Packages/com.unitt.avatar-mod/README.md" 'Wardrobe Inventory'
assert_contains "Packages/com.unitt.avatar-mod/README.md" '左側'
assert_contains "Packages/com.unitt.avatar-mod/README.md" 'right-side inventory'
assert_contains "Packages/com.unitt.avatar-mod/README.md" 'Wear'
...
assert_contains "Packages/com.unitt.avatar-mod/Editor/UnittAvatarModWindow.cs" 'DrawAvatarPreviewPanel'
assert_contains "Packages/com.unitt.avatar-mod/Editor/UnittAvatarModWindow.cs" 'DrawInventoryPanel'
assert_contains "Packages/com.unitt.avatar-mod/Editor/UnittAvatarModWindow.cs" 'AssetDatabase.FindAssets("t:Prefab")'
assert_contains "Packages/com.unitt.avatar-mod/Editor/UnittAvatarModWindow.cs" 'AssetPreview.GetAssetPreview'
assert_contains "Packages/com.unitt.avatar-mod/Editor/UnittAvatarModWindow.cs" 'WearInventoryPrefab'
assert_contains "Packages/com.unitt.avatar-mod/Editor/UnittAvatarModWindow.cs" 'Avatar Preview'
assert_contains "Packages/com.unitt.avatar-mod/Editor/UnittAvatarModWindow.cs" 'Wardrobe Inventory'
assert_contains "Packages/com.unitt.avatar-mod/Editor/UnittAvatarModWindow.cs" 'Wear'
